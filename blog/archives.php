...
<div class="archive-banner">
    ...
    <p class="archive-banner-badge"># Post Category</p>
    <em class="archive-banner-count">{{ cate_info.posts_count }} articles in total</em>
</div>
<div class="blog-container" v-loading="!loaded" style="width:50%;margin-top:5vh">
    ...
    <template v-for="(post,index) in posts" v-if="post.info.Cate !== '<?php echo $site->index_exclude ?>'">
        <el-card shadow="hover" class="stream-card-archive">

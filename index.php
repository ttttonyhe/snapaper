...
<div class="uk-container uk-animation-slide-bottom-small" style="margin-top: 6%;" uk-scrollspy="target: > .uk-card; cls:uk-animation-slide-bottom-small; delay: 200">
    <div class="sub-title-div">
        ...
        <a onclick="set_server();" style="color: #666;border: 1px solid #666;padding: 3px 8px 4px 8px;border-radius: 4px;margin-left: 10px;position: absolute;margin-top: 18px;" uk-tooltip="title: <b>Notice</b><br/>When there is a problem with our service, you can choose to switch to another server by clicking here.; pos: right" id="switch"><svg width="17" height="17" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="refresh" style="margin-top: -3px;margin-right: 3px;">
                <path fill="none" stroke="#666" stroke-width="1.1" d="M17.08,11.15 C17.09,11.31 17.1,11.47 17.1,11.64 C17.1,15.53 13.94,18.69 10.05,18.69 C6.16,18.68 3,15.53 3,11.63 C3,7.74 6.16,4.58 10.05,4.58 C10.9,4.58 11.71,4.73 12.46,5"></path>
                <polyline fill="none" stroke="#666" points="9.9 2 12.79 4.89 9.79 7.9"></polyline>
            </svg>Switch Server</a>
    ...
    <div>
        <div class="uk-card uk-card-default uk-card-hover uk-card-body index-card">
            ...
            <a href="/onestep">
                <p class="item-guide">Find Yourself a Paper</p><i class="uk-slidenav-previous uk-icon uk-slidenav uk-slidenav-next"><svg width="14" height="14" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg" ratio="1">
        ...
        <div class="uk-card uk-card-default uk-card-hover uk-card-body index-card">
            ...
            <a href="/cate?cate=<?php if ($_COOKIE['snapaper_server'] == 4) echo 'Cambridge%20IGCSE';
                                else echo 'IGCSE'; ?>">
                <p class="item-guide">Browse All Subjects</p><i class="uk-slidenav-previous uk-icon uk-slidenav uk-slidenav-next"><svg width="14" height="14" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg" ratio="1">
                        <polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "></polyline>
                    </svg></i>
            </a>
        </div>
        ...
        <div class="uk-card uk-card-default uk-card-hover uk-card-body index-card" style="border-color: #ff85c0;">
            ...
            <a href="/cate?cate=<?php if ($_COOKIE['snapaper_server'] == 4) echo 'Cambridge%20International%20AS%20%26%20A%20Levels';
                                else echo 'A Levels'; ?>">
                <p class="item-guide">Browse All Subjects</p><i class="uk-slidenav-previous uk-icon uk-slidenav uk-slidenav-next"><svg width="14" height="14" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg" ratio="1">
                        <polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "></polyline>
                    </svg></i>
        ...
        <div class="uk-card uk-card-default uk-card-hover uk-card-body index-card" style="padding: 30px;border-color:rgba(0, 172, 237, 0.9);width:47.7%">
            <h3 class="uk-card-title index-cate-h3" style="margin-bottom: 3px;">2019 F/M A-Level Series</h3><a href="/case/?cate=alevel">
                <p class="item-guide" style="margin: 0px;">See What's Available</p><i class="uk-slidenav-previous uk-icon uk-slidenav uk-slidenav-next"><svg width="14" height="14" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg" ratio="1">
                        <polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "></polyline>
                    </svg></i>
            </a>
    ...
    <div class="uk-card uk-card-default uk-card-hover uk-card-body" style="border-top: 4px solid #03A9F4;width: 47.5%;border-radius: 5px;margin-bottom: 5%;margin-top:2%;display: inline-block;padding-bottom: 50px;">
        ...
        <a href="/sme" style="float: right;padding-top: 15px;text-decoration:none;">
            <p style="margin-top: 15px;">Click Here<i class="uk-slidenav-previous uk-icon uk-slidenav uk-slidenav-next"><svg width="14" height="14" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg" ratio="1">
                        <polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "></polyline>
                    </svg></i></p>
        </a>
    </div>
    <div class="uk-card uk-card-default uk-card-hover uk-card-body" style="border-top: 4px solid #fbbd01;width: 47.5%;border-radius: 5px;margin-bottom: 5%;margin-top:2%;display: inline-block;padding-bottom: 50px;margin-left: 2.5%;">
        ...
        <a href="donate" style="float: right;padding-top: 15px;text-decoration:none;">
            <p style="margin-top: 15px;">Click Here<i class="uk-slidenav-previous uk-icon uk-slidenav uk-slidenav-next"><svg width="14" height="14" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg" ratio="1">
                        <polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "></polyline>
                    </svg></i></p>
        </a>
    ...
    <div class="uk-card uk-card-default uk-card-hover uk-card-body" style="border-top: 4px solid #52c41a;width: 47.5%;border-radius: 5px;margin-bottom: 5%;margin-top:-2%;display: inline-block;padding-bottom: 50px;">
        ...
        <a href="/cate?cate=O Levels" style="float: right;padding-top: 15px;text-decoration:none;">
            <p style="margin-top: 15px;">Click Here<i class="uk-slidenav-previous uk-icon uk-slidenav uk-slidenav-next"><svg width="14" height="14" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg" ratio="1">
                        <polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "></polyline>
                    </svg></i></p>
        </a>
    ...
    <div class="uk-card uk-card-default uk-card-hover uk-card-body" style="border-top: 4px solid #673AB7;width: 47.5%;border-radius: 5px;margin-bottom: 5%;margin-top:-2%;display: inline-block;padding-bottom: 50px;margin-left: 2.5%;">
        ...
        <a href="about" style="float: right;padding-top: 15px;text-decoration:none;">
            <p style="margin-top: 15px;">Click Here<i class="uk-slidenav-previous uk-icon uk-slidenav uk-slidenav-next"><svg width="14" height="14" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg" ratio="1">
                        <polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "></polyline>
                    </svg></i></p>
        </a>
    ...
    <p class="index-copy">©2018-2019 Snapaper | Made with <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">

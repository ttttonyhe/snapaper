...
<div class="uk-container uk-animation-slide-bottom-small wap-index" style="margin-top: 10%;" uk-scrollspy="target: > .uk-card; cls:uk-animation-slide-bottom-small; delay: 200">
    ...
    <div>
        <div class="uk-card uk-card-default uk-card-hover uk-card-body index-card">
            <h3 class="uk-card-title index-cate-h3"><i class="czs-hand-button"></i>One Step&nbsp;<span class="uk-label uk-label-success nav-title-v">Extension</span></h3>
    ...
    display: flex;
">
<div class="uk-card uk-card-default uk-card-hover uk-card-body index-card uk-scrollspy-inview special-index" style="border-color: #03A9F4;margin-left: 0px;width: 47.85%;padding: 30px 0px 35px 30px;">
            <h3 class="uk-card-title index-cate-h3">OCR Further Maths<p style="font-size: 16px;font-weight: 400;letter-spacing: .5px;color: #666;margin: 0px;">Resources from ExamSolutions.Net</p>
            <a target="_blank" href="https://www.examsolutions.net/a-level-maths/ocr/" style="float: right;font-size: 16px;font-weight: 400;margin-top: -45px;margin-right: 30px;border-radius: 5px;padding: 5px 10px;letter-spacing: .2px;">
                <p class="item-guide" style="margin: 0px;">Visit Website<i class="uk-slidenav-previous uk-icon uk-slidenav uk-slidenav-next"><svg width="14" height="14" viewBox="0 0 14 24" xmlns="http://www.w3.org/2000/svg" ratio="1"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1.225,23 12.775,12 1.225,1 "></polyline></svg></i></p></a>
            </h3>

...
"> <circle fill="none" stroke="#666" stroke-width="1.1" cx="10" cy="10" r="9"></circle> <line fill="none" stroke="#666" stroke-width="1.1" x1="4" y1="3.5" x2="16" y2="16.5"></line></svg>
...
">Service is temporarily unavailable</h2>
    </div><div class="uk-card uk-card-default uk-card-hover uk-card-body" style="border-top: 4px solid #52c41a;width: 97.8%;border-radius: 5px;margin-bottom: 5%;margin-top:2%;padding-bottom: 40px;">
